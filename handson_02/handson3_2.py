# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 01:43:34 2017
...
wv.write('./4x_sound_01.wav',dFa,vtSomint16)#salva amomstra de som para ser reproduzida
#reproduz a amostra de som salva
os.system('cvlc --play-and-exit ./4x_sound_01.wav')           
